<template>
  ...
  <div class="mb-4">
    ...
    <div class="mt-4">
        <router-link to="/loginpage" class="text-center w-full bg-green-400 hover:bg-green-600 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
      Sign In
        </router-link>    
  </div>
  </form>
